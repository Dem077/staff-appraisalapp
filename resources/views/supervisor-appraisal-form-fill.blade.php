...
{{--        <p class="text-center text-gray-500 text-base md:text-lg mb-6 md:mb-10 font-medium">Probationary Period Evaluation</p>--}}
        ...
        <form method="POST" action="{{ route('supervisor-appraisal-form-fill.submit', $assigned->id) }}" class="space-y-6 md:space-y-8">
                                ...
                                @foreach($behavior['indicators'] as $indicatorIndex => $indicator)
                                    <div class="bg-gray-50 p-3 md:p-5 rounded-xl border border-gray-200 mb-3 md:mb-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {{-- Staff filled data --}}
                                            <div>
                                                <div class="text-xs text-gray-500 mb-1">Staff Score</div>
                                                <div class="font-bold text-green-700 mb-2">{{ $indicator['selfScore'].'/5' ?? '-' }}</div>
                                            </div>
                                            {{-- Supervisor fields --}}
                                            <div>
                                                ...
                                                <label class="block text-xs text-gray-500 mb-1">Supervisor Comment</label>
                                                <textarea
            ...
            <div class="bg-gray-50 p-3 md:p-6 rounded-2xl border border-gray-200 shadow-sm">
                <h2 class="text-xl md:text-2xl font-semibold text-green-700 mb-3 md:mb-5">Supervisor Comments</h2>
                <textarea
